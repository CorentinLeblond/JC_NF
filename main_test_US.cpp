...
double rate = 0.05;
double atm_fwd = 100 * exp(-rate);
std::vector<std::vector<double>> Spot_vector = {{95},{98},{92}};
...
//////// TEST US ////////////////////////////////////////////////////////////
	...
	basefunc.push_back(new Poly_Hermite(0));
	basefunc.push_back(new Poly_Hermite(1));
	basefunc.push_back(new Poly_Hermite(2));
	basefunc.push_back(new Poly_Hermite(2));
	basefunc.push_back(new Poly_Hermite(4));
	basefunc.push_back(new Poly_Hermite(5));


	//basefunc.push_back(new polynome_simple(0));
	//basefunc.push_back(new polynome_simple(1));
	//basefunc.push_back(new polynome_simple(2));
	//basefunc.push_back(new polynome_simple(3));
	//basefunc.push_back(new polynome_simple(4));
	//basefunc.push_back(new polynome_simple(5));
